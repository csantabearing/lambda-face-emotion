...
VERBOSE = False
R_tokenizer = AutoTokenizer.from_pretrained('distilbert-base-uncased-finetuned-sst-2-english',
                                            padding_side='left')
input_name = ['input__0']
output_name = 'output__0'


def run_inference(premise, model_name='distilbert', url='44.206.242.119:8000', model_version='1'):
